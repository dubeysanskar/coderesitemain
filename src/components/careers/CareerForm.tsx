...
import { submitCareerApplication, type CareerFormData } from '@/lib/career-service';
...
const CareerForm = () => {
  ...
  const handleInputChange = (name: keyof CareerFormData, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast({
        ...
        description: result.message || 'Thank you! Your application has been submitted. We will contact shortlisted candidates.'
      });
