      ...
      <Card className="bg-gray-900 border-gray-700">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm">Separate skills with commas. Remove irrelevant categories.</p>
          </div>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Button
                ...
                onClick={() => setValue("skills.programmingLanguages", [])}
              >
                <X className="w-3 h-3" />
              </Button>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Button
                ...
                variant="ghost"
                className="text-red-400 hover:text-red-300 p-1"
                onClick={() => setValue("skills.frameworks", [])}
              >
                <X className="w-3 h-3" />
              </Button>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Button
                ...
                variant="ghost"
                className="text-red-400 hover:text-red-300 p-1"
                onClick={() => setValue("skills.softSkills", [])}
              >
                <X className="w-3 h-3" />
              </Button>
            </div>
      ...
      <Card className="bg-gray-900 border-gray-700">
        ...
        <CardContent className="space-y-4">
          {customSections.map((section, sectionIndex) => (
            <div key={sectionIndex} className="border border-gray-700 rounded-lg p-4">
                ...
                {section.fields.map((field, fieldIndex) => (
                  <div key={fieldIndex} className="grid grid-cols-5 gap-2">
                    ...
                    <Input
                      ...
                      className="bg-gray-800 border-gray-600 text-white col-span-3"
                    />
                  </div>
                ))}
                <Button
